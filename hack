...
local masterygui = loadstring(game:HttpGet("https://raw.githubusercontent.com/DonjoScripts/Public-Scripts/refs/heads/Slap-Battles/Mastery-FarmGUI"))()
end)
...
loadstring(game:HttpGet("https://pastefy.app/hcG2LK3k"))()
end)
